...
XmlProcessing::XmlDocument& XmlProcessing::XmlDocument::operator=(XmlDocument&& doc)
{
...
sPtr XmlProcessing::XmlDocument::xmlRoot()
{
...
bool XmlProcessing::XmlDocument::xmlRoot(sPtr pRoot)
{
...
size_t XmlProcessing::XmlDocument::size()
{
